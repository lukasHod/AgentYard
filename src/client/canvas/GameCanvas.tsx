...
import { type ShipPanelTab } from '../components/ShipDetailsPanel'
 ...
 * of state shared with the HUD (selected ship, current panel tab, hover
...
export function GameCanvas(props: Props) {
  ...
  const fitGalaxy = useCallback(() => galaxyRef.current?.fitToShips(), [])
  ...
  return (
    <div className="flex-1 relative overflow-hidden bg-black">
      ...
      <GameHud
        ...
        onCreateShip={props.onCreateShip}
        onDeleteShip={props.onDeleteShip}
